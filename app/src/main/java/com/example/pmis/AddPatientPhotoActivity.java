...
public class AddPatientPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_patient_photo);
        Toolbar myToolbar = (Toolbar) findViewById(R.id.myToolbar6);
        setSupportActionBar(myToolbar);
        getSupportActionBar().setTitle("Add Patient Photo");
    ...
    private final View.OnClickListener saveMedicalHistory = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            PatientPhotos patientPhotos = new PatientPhotos();
            ...
            StorageReference image = mStorageRef.child("images/patientPhotos/" + patientKey + "/" + fileName);
            image.putFile(contentUri).addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    patientPhotos.setDate(dateUpdated);
                    patientPhotos.setKey(key);
                    patientPhotos.setImageUrl(fileName);
                    patientPhotos.setCaption(etCaption.getText().toString().trim());
                    myRef.child(key).setValue(patientPhotos).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(AddPatientPhotoActivity.this, "Patient Photo has been added", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    });
                }
