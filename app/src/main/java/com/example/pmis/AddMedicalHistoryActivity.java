...
public class AddMedicalHistoryActivity extends AppCompatActivity {
    ...
    String currentPhotoPath, patientKey;
    Uri contentUri;
    private EditText etCaption;
    private FirebaseAuth mAuth;
    private FirebaseDatabase mFirebaseDatabase;
    private DatabaseReference myRef;
    private String userID, imageName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        patientKey = i.getStringExtra("patientKey");
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        ImageView ivMedicalHistory = findViewById(R.id.ivMedicalHistory);
